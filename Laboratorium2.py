...
# określ indeks osoby które imie podaje użytkownik
# nazwę osoby podaje użytkownik
# ile osób o imieniu wskazanym przez użytkownika znajduje się na liście

# list_name = [ 'Anna', 'Bartek', 'Kasia', 'Tomek', 'Marta', 'Kasia', 'Michał', 'Wojtek',
#   'Aleksandra', 'Marta']
...
# dane_osobowe = {'imie': ['Ola', 'Ala'],'nazwisko': ['Kwiatkowska', 'Kowalska'],'wiek': ['25', '30']}

# id = int(input('Podaj index od 0 do 1: '))
# print(dane_osobowe['imie'][id])
# print(dane_osobowe['nazwisko'][id])
# print(dane_osobowe['wiek'][id])
...
# dane_osobowe = {'imie': ['Ola', 'Ala'],'nazwisko': ['Kwiatkowska', 'Kowalska'],'kierunek': ['Kognitywistyka','Informatyka']}

# print(dane_osobowe)
# dane_osobowe.update({'kierunek2':['fizyka','matematyka']})
...
# dane_osobowe = {'imie': ['Ola', 'Ala'],'nazwisko': ['Kwiatkowska', 'Kowalska'],'wiek': ['25', '30'],'kierunek': ['Kognitywistyka','Informatyka']}

# print(dane_osobowe.keys())
# l = len(dane_osobowe.keys())
# print(l)
